...
from siril.Transformer.transformer import \
    VideoGPTTransformer
from siril.Transformer.utils import load_video_data
from siril.sir.sir import SIR
...
class Train_transformer:
    ...
    def compute_loss(self, imgs):                
        ...
        logits, targets = self.model.output(imgs, compute_joint=True)
...
@hydra.main(config_path="../siril/configs/transformer", config_name="default")
def main(args):
