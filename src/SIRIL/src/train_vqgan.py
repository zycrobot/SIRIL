...
from siril.VQGAN.discriminator import Discriminator
from siril.VQGAN.lpips import LPIPS
from siril.VQGAN.utils import load_data, weights_init
from siril.VQGAN.vqgan import VQGAN
...
@hydra.main(config_path="../siril/configs/vqgan", config_name="default")
def main(cfg):
    TrainVQGAN(cfg)
